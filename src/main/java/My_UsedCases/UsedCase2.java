...
public class UsedCase2 {
    long count=0;
    public static long My_func_swap(){
        ...
        Dataset<Row> sqlDf = spark.sql("SELECT c.*\n" +
                "FROM orders o right outer JOIN customers c\n" +
                "    ON o.order_customer_id =c.customer_id\n" +
                "WHERE date_format(o.order_date, 'yyyy-MM-dd') LIKE '2014-01%' and o.order_id is null\n" +
                "ORDER BY c.customer_id");
        return sqlDf.count();
    }
    static final Logger logger = Logger.getLogger(UsedCase2.class);
    public static void main(String[] args) {
        ...
        String path = "C:\\Users\\Shridhar Ingale\\IdeaProjects\\UseCases1\\src\\main\\UseCaseOutput\\UsedCase2";
